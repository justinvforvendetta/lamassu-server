    ...
    .then(machineList => ({
      ...
      cryptoCurrencies: [
        ...
        {crypto: 'BCH', display: 'Bitcoin Cash'},
         {crypto: 'XVG', display: 'Verge Currency'}
      ],
      languages: languages,
      countries,
      accounts: [
        ...
        {code: 'verged', display: 'verged', class: 'wallet', cryptos: ['XVG']},
        ...
        {code: 'all-zero-conf', display: 'Always 0-conf', class: 'zeroConf', cryptos: ['BTC', 'ZEC', 'LTC', 'DASH', 'BCH', 'XVG']},
        ...
        {code: 'mock-zero-conf', display: 'Mock 0-conf', class: 'zeroConf', cryptos: ['BTC', 'ZEC', 'LTC', 'DASH', 'BCH','XVG', 'ETH']}
      ],
